...
class ChatsMessage(models.Model):
    ...
    sender = models.ForeignKey(AccountsCustomuser, models.DO_NOTHING, blank=True, null=True)
    room_id = models.ForeignKey('ChatsRoom', models.DO_NOTHING)
...
class UserRoom(models.Model):
    room = models.ForeignKey(ChatsRoom, models.DO_NOTHING)
    user = models.ForeignKey(AccountsCustomuser, models.DO_NOTHING)
